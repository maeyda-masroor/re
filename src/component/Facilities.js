function Facilities(){
   return  <div class="container">
    <h1 style={{fontSize:"25px",fontFamily:'Serif'}}>Casualty</h1>
<p style={{fontFamily:'Serif'}}>
The Casualty of Remedial Centre is attended by approximately 1800-2000 patients per month. It provides emergency medical services with state of the art technology and trained doctors and staff.
...
<hr/>
<h1 style={{fontSize:'25px',fontFamily:"Serif"}}>
Observation after Initial Treatment
</h1>
<p style={{fontFamily:'Serif'}}>
Patients needing observation of 3-6 hours to get stabilized are kept under observation & necessary investigations are done.</p>
<hr/>
<h1 style={{fontSize:'25px',fontFamily:'Serif'}}>
Admissions
</h1>
...
<p>The Laboratory provides 24Hrs' services, performing all routine tests, for out Patients as well as In-patients. It is equipped with the latest machinery & tests are performed by highly trained technicians. Special investigations such as HbsAg, HCV,ProBNP, Trop-T, D-Dimer, Typhoid, & stool for H.Pylori
</p>
<hr/>
</div>
