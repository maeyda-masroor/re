        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6" data-wow-delay="0.5s">
                    ...
                    <p class = "heading" style={{color:'#986931'}}>
...
The hospital has well qualified paramedical staff and doctors, it is fully furnished with all kinds of latest Medical/Surgical equipments and facilities.
      ...
      <button onClick={toggleReadMoreLess}>
        {isShowMore ? "Read Less" : "Read More"}
                 ...
                 <p class="mb-1"><i class="far fa-check-circle color me-1"></i>Quality health care</p>
                    <p clas="mb-1"><i class="far fa-check-circle color me-1"></i>Only Qualified Doctors</p>
                </div>
            </div>
        </div>
    </div>
