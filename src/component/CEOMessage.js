            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <u style={{color:'#986931'}}><i><b><h1 class="mb-1" style={{fontSize:'45px',color:'#986931'}}>CEO Message</h1></b></i></u>
                        <i><p class = "heading" style={{color:'#986931'}}>We have a vision at Remedial Centre to provide medical services to the local community at reasonable costs delivered by competent doctors, caring staff, and modern equipment with prompt response to medical emergencies.
