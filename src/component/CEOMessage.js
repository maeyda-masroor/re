            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <b><h1 class="mb-1" style={{fontSize:'60px',color:'#986931'}}>CEO Message</h1></b>
                        <p class = "heading" style={{color:'#986931'}}>We have a vision at Remedial Centre to provide medical services to the local community at reasonable costs delivered by competent doctors, caring staff, and modern equipment with prompt response to medical emergencies.
